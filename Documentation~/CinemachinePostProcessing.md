...
5. In the [Inspector](https://docs.unity3d.com/Manual/UsingTheInspector.html), choose __Add Extension > CinemachinePostProcessing__, then configure the Profile asset to have the effects you want when this virtual camera is live.
